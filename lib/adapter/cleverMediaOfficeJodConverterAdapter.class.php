<?php
/**
 * cleverMediaOdfJodConverterAdapter is an adapter for openoffice readable
 * documents, using OpenOffice and JobConverter
 *
 * @package    cleverMediaOfficeJodConverterAdapter
 * @author     Xavier Lacot <xavier@lacot.org>
 */
class cleverMediaOfficeJodConverterAdapter extends cleverMediaAdapter
{
