...
function cml_display_media($cc_media, $options = array())
{
  $options['cc_media'] = $cc_media;
  $type = $cc_media->getType();
  $partial = 'cleverMediaLibrary/media_types/view'.(('' != $type) ? '_'.$type : '');
