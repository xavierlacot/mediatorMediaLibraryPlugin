...
/**
 * PluginCcMediaFolder form.
 *
 * @package    form
 * @subpackage CcMediaFolder
  ...
  public function setup()
  {
    if (is_null($this->getObject()->getFolderPath()))
    {
      ...
      $this->setValidators(array(
        ...
        'parent' => new sfValidatorDoctrineChoice(array('model' => 'ccMediaFolder', 'column' => 'id', 'required' => true)),
      ));
    }
    else
    {
      $this->setWidgets(array(
        ...
        'parent'      => new sfWidgetFormDoctrineChoice(array('model' => 'ccMediaFolder', 'method' => '__toStringWithDepth')),
        'auto_path'   => new sfWidgetFormInputCheckbox(),
      ));

      $this->setValidators(array(
        'id'          => new sfValidatorDoctrineChoice(array('model' => 'ccMediaFolder', 'column' => 'id', 'required' => false)),
      ...
      $this->setDefault('auto_path', $folder_path == cleverMediaLibraryInflector::toUrl($name));
      $this->setDefault('parent', $this->getObject()->getNode()->getParent()->getPrimaryKey());
    }

    $this->widgetSchema->setNameFormat('cc_media_folder[%s]');
  }

  public function doSave($con = null)
  {
    $parent = Doctrine::getTable('ccMediaFolder')->find($this->values['parent']);
