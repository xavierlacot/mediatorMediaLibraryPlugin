<?php
class cleverMediaOfficeHandler extends cleverMediaHandler
{
  /**
  ...
  protected function getAdapter($options = array())
  {
    if (!isset($this->adapter))
    {
      ...
      {
        $adapterClass = 'cleverMediaOfficeJodConverterAdapter';
      }
      else
      {
  ...
  public function process(array $sizes)
  {
    ...
    $directory = cleverMediaLibraryToolkit::getDirectoryForSize('original');
    $previous_image = '';
